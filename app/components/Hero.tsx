  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(10,10,10,0.72) 0%, rgba(10,10,10,0.55) 50%, rgba(10,10,10,0.85) 100%)",
        }}
        aria-hidden="true"
      />
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 40% at 50% 0%, rgba(242,169,0,0.09) 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
